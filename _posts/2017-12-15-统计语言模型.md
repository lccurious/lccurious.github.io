...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="asssets/img/2017-12-15-统计语言模型/1.gif" title="Bengio Yoshua提出的神经网络结构" class="img-fluid rounded z-depth-1" caption="Bengio Yoshua提出的神经网络结构" %}
    </div>
</div>
